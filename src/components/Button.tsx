...
type Variant = "primary" | "ghost" | "outline" | "danger" | "destructive";
type Size = "sm" | "md";
...
const variants: Record<Variant, string> = {
  ...
  destructive:
    "border border-danger/40 bg-danger/10 text-danger shadow-sm hover:bg-danger/20 hover:border-danger/60",
};
