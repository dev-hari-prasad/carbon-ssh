...
import { Docker, Linux, Slack, Spotify, VisualStudioCode } from "@ridemountainpig/svgl-react";
...
export function OnboardingModal() {
  ...
  const [setupStatus, setSetupStatus] = useState<"idle" | "success" | "error" | "skipped">(
    access.appLockEnabled ? "success" : "idle",
  );
                        ...
                        <motion.img
                          ...
                          src={
                            currentTheme.type === "light"
                              ? "/logo/Carbon logo dark.svg"
                              : "/logo/Carbon logo light.svg"
                          }
                          alt="Carbon"
                          className="h-14 mb-3"
                        />
                    ...
                    <div className="flex flex-col gap-4 w-full max-w-[400px]">
                      ...
                      <div className="flex flex-col gap-3">
                        <div className="flex flex-col min-w-0">
                          <span className="text-[14px] font-sans font-medium text-fg">
                            Tab styling
                          </span>
                        </div>
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="w-full">
                          <OnboardingThemeSelector
                            ...
                            onSelect={(id) => actions.setTheme(id)}
                            compact
                          />
                        </div>
                      </div>
                ...
                <div className="flex flex-col h-full px-0">
                  <div className="mb-6 mt-0 shrink-0">
                    ...
                    <p className="text-fg-muted text-[13px]">
                      Choose how you want to unlock your data.
                    </p>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col justify-center items-center pb-12 pr-2 w-[70%] mx-auto">
                    {showRecoverySetup ? (
                      ...
                      >
                        ...
                        <p className="text-fg-muted mb-6 text-center text-[13px] leading-relaxed">
                          Your data is currently unprotected. We highly recommend enabling a lock
                          for security.
                        </p>
                      ...
                      >
                        <TabsList className="grid w-full grid-cols-2 mb-4 bg-[var(--bg-panel)] border border-border h-9 p-1 relative overflow-hidden">
                          <TabsTrigger
                            value="passkey"
                            className="z-10 data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:text-fg"
                          >
                            ...
                            {activeTab === "passkey" ? (
                              ...
                              >
                                <p className="text-[13px] text-fg-muted text-center mx-auto mt-4">
                                  Uses Touch ID or Windows Hello. <br /> You can change this later
                                  in settings.
                                </p>
                                {error && (
                              ...
                              >
                                ...
                                <div className="flex flex-col gap-1.5">
                                  <Button
                                    onClick={attemptPasswordSetup}
                                    className="w-full bg-accent text-accent-fg hover:opacity-90 h-10 mt-3"
                                  >
                                    Set Password
                                  </Button>
                                  <Button
                    ...
                    <AlertDialog open={showSkipWarning} onOpenChange={setShowSkipWarning}>
                      ...
                      >
                        ...
                        <AlertDialogFooter className="mt-3">
                          <AlertDialogAction
                            onClick={confirmSkipLock}
                            className="bg-danger text-white hover:bg-danger/90"
                          >
                            Skip anyway
                          </AlertDialogAction>
                          <AlertDialogCancel className="border-border bg-transparent text-fg hover:bg-[var(--menu-hover-bg)]">
                            Cancel
                          </AlertDialogCancel>
                        </AlertDialogFooter>
                      </AlertDialogContent>
              ...
              {step === 4 && (
                <div className="flex flex-col h-full px-0">
                  <div className="mb-6 mt-0 shrink-0">
                    ...
                    <p className="text-fg-muted text-[13px]">
                      Set your final preferences to get started.
                    </p>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col justify-center items-center pb-12 mb-10 max-w-[400px] mx-auto w-full">
                    <div className="space-y-3 w-full">
                      <div className="flex items-center justify-between gap-4 p-4 rounded-xl border border-border bg-[var(--bg-panel)]">
                        ...
                        <Switch checked={pinToTaskbar} onCheckedChange={setPinToTaskbar} />
                      </div>
          ...
          <div className="absolute bottom-10 left-10 right-10 flex items-center justify-between mt-auto">
            {step > 1 ? (
              <Button
                ...
                variant="outline"
                className="text-sm text-fg-muted hover:text-fg font-medium"
              >
                Back
              </Button>
            ) : (
            ...
            {step < STEPS && step !== 3 ? (
              <Button
                onClick={handleNext}
                className="bg-accent text-accent-fg hover:opacity-90 flex items-center gap-2 pl-4 pr-2 h-8 text-xs font-semibold rounded-md"
              >
                Next
                <Kbd
                  variant="onAccent"
                  className="border-none bg-transparent shadow-none opacity-85"
                >
                  <KeyReturn weight="bold" size={12} />
                </Kbd>
              </Button>
            ) : step === 3 ? (
              setupStatus === "idle" ? (
                  ...
                  <Tooltip delayDuration={0}>
                    <TooltipTrigger asChild>
                      <div className="inline-block">
                        <Button
                          disabled
                          className="bg-accent/50 text-accent-fg/50 cursor-not-allowed flex items-center gap-2 pl-4 pr-2 h-8 text-xs font-semibold rounded-md"
                        >
                          Next
                          <Kbd
                            variant="onAccent"
                            className="border-none bg-transparent shadow-none opacity-65"
                          >
                            <KeyReturn weight="bold" size={12} />
                          </Kbd>
                        </Button>
        ...
        >
          ...
          <AnimatePresence>
            {step === 4 && (
              ...
              >
                <FakeDock
                  platform={(window as any).electron?.platform || "win32"}
                  theme={currentTheme}
                  pinned={pinToTaskbar}
                />
              </motion.div>
...
function SubTabBtn({
  ...
  return (
    ...
    >
      <button
        onClick={onClick}
        className={`h-full w-full px-4 rounded-[6px] text-[12.5px] font-sans transition-colors flex items-center justify-center z-10 ${
...
function OnboardingThemeSelector({
  activeThemeId,
  onSelect,
  compact = false,
}: {
  ...
  return (
    <div
      className={`flex flex-col gap-2.5 flex-1 justify-center items-center w-full ${compact ? "" : "max-w-[80%] mx-auto mb-8"}`}
    >
      <div
        className={`p-1 flex items-stretch h-9 gap-1 rounded-md bg-[var(--command-bg)] border border-border w-full ${compact ? "" : "max-w-[400px]"}`}
      >
        <SubTabBtn
          active={tab === "dark"}
          onClick={() => setTab("dark")}
          className="flex-1"
          layoutId="step3-theme-bg"
        >
...
function FakeDock({
          ...
          return (
            <div key={item.id} className="relative flex flex-col items-center group">
              ...
              >
                {item.isCarbon ? (
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center shadow-lg ring-1 ${isDark ? "bg-black ring-white/10" : "bg-white ring-black/5"}`}
                  >
                    <img
    ...
    return (
      ...
      >
        ...
        >
          <svg
            viewBox="0 0 24 24"
            className={`w-5 h-5 ${isDark ? "text-[#00a4ef]" : "text-[#0078d7]"}`}
            fill="currentColor"
          >
          ...
          return (
            <div key={item.id} className="relative group flex flex-col items-center">
              ...
              >
                {item.isCarbon ? (
                  <div
                    className={`w-9 h-9 rounded-md flex items-center justify-center shadow-sm ring-1 ${isDark ? "bg-white/10 ring-white/10" : "bg-black/5 ring-black/5"}`}
                  >
                    <img
                      src={isDark ? "/logo/Carbon logo light.svg" : "/logo/Carbon logo dark.svg"}
                      alt=""
  ...
  return (
    ...
    >
      ...
      {icons.map((item) => {
        const isGrayscale = !pinned;
        const delay = pinned ? (item.isCarbon ? "0ms" : "100ms") : item.isCarbon ? "100ms" : "0ms";
    ...
    const draw = (time: number) => {
      ...
      for (let i = 0; i < cols; i++) {
        for (let j = 0; j < rows; j++) {
          ...
          const alpha =
            baseAlpha + (intensity * 0.2 + shimmerIntensity * highlightMax) * powerRef.current;
...
function MiniAppPreview({
  ...
  return (
    ...
    >
      {/* Title Bar */}
      <div
        className="w-full shrink-0 flex items-center px-4 select-none"
        style={{ height: TITLE_BAR_HEIGHT }}
      >
        <div className="flex items-center gap-2">
          <img
            src={
              theme.type === "light" ? "/logo/Carbon logo dark.svg" : "/logo/Carbon logo light.svg"
            }
            alt=""
            className="h-3.5"
          />
        ...
        <div className="ml-auto flex items-center gap-5 opacity-40">
          <div
            className="w-3 h-[1px] bg-current"
            style={{ backgroundColor: v["--titlebar-fg"] || "#fff" }}
          />
          <div
            className="w-3 h-3 border border-current opacity-80"
            style={{ borderColor: v["--titlebar-fg"] || "#fff" }}
          />
          <div className="relative w-3.5 h-3.5">
            <div
              className="absolute top-1/2 left-0 w-full h-[1px] bg-current rotate-45"
              style={{ backgroundColor: v["--titlebar-fg"] || "#fff" }}
            />
            <div
              className="absolute top-1/2 left-0 w-full h-[1px] bg-current -rotate-45"
      ...
      <div className="flex-1 w-full flex overflow-hidden">
        ...
        <AnimatePresence mode="popLayout">
          {tabBarOrientation === "vertical" && (
            ...
            >
              ...
              >
                <div
                  className="w-5 h-5 rounded-sm opacity-20"
                  style={{ backgroundColor: v["--fg"] }}
                />
              </div>
            </motion.div>
        ...
        <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
            ...
            {tabBarOrientation === "horizontal" && (
              ...
              >
                ...
                >
                  ...
                  />
                  <div
                    className="h-2.5 w-20 rounded-sm opacity-60"
                    style={{ backgroundColor: v["--fg"] }}
                  />
                </div>
                <div
                ...
                >
                  ...
                  />
                  <div
                    className="h-2.5 w-20 rounded-sm opacity-30"
                    style={{ backgroundColor: v["--fg"] }}
                  />
                </div>
              </motion.div>
          ...
          <div
            className={`flex-1 min-h-0 ${tabBarOrientation === "horizontal" ? "px-2 pb-2" : "p-2 pl-0.5"}`}
          >
            <div
            ...
            >
              <div className="flex-1 min-h-0 flex relative overflow-hidden">
                    ...
                    >
                      ...
                      >
                        <div
                          ...
                          style={{ backgroundColor: v["--fg-muted"] }}
                        />
                      </div>
                      <div className="p-3 flex flex-col gap-1.5">
                        <div
                          className="h-8 w-full rounded-md border flex items-center px-3 gap-3"
                          style={{
                            backgroundColor: v["--command-active-bg"],
                            borderColor: v["--border-strong"],
                          }}
                        >
                          <div
                            className="w-2.5 h-2.5 rounded-full"
                            style={{ backgroundColor: v["--success"] }}
                          />
                          <div
                ...
                {/* Terminal View */}
                <div
                  className="flex-1 p-8 font-mono text-[13px] leading-[2.2] overflow-hidden whitespace-nowrap"
                  style={{ color: v["--fg"] }}
                >
                  ...
                  <div
                    style={{ color: v["--syntax-comment"] }}
                    className="text-[12px] opacity-80 leading-relaxed"
                  >
                    Last login: Wed May 13 02:24:36 2026 from 1.2.3.4
                    <br />
                  ...
                  <div className="mt-1 opacity-50 text-[11px] leading-tight font-mono">
                    ...
                    <br />
                    7a83d1e2b4c1 redis:alpine "docker-e…" Up 12 hours 6379/tcp
                    <br />
                  ...
                  <div className="mt-8 flex items-center gap-2">
                    ...
                    <span style={{ color: v["--syntax-keyword"] }}>#</span>
                    <span
                      className="w-2 h-5 inline-block animate-pulse"
                      style={{ backgroundColor: v["--fg"] }}
                    />
                  </div>
                </div>
              ...
              >
                ...
                <div className="ml-auto">
                  <div
                    className="h-3 w-16 rounded-sm opacity-50"
                    style={{ backgroundColor: v["--fg-muted"] }}
                  />
                </div>
              </div>
        ...
        {showBlur && (
          ...
          >
            ...
            >
              ...
              <div
                className="h-5 w-40 rounded-sm"
                style={{ backgroundColor: v["--fg"], opacity: 0.5 }}
              />
              <div
                className="h-12 w-full rounded-lg mt-2 border"
