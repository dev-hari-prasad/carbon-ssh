    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          description:
            "group-[.toast]:!text-[var(--fg-muted)] group-[.toast]:!text-[10px] group-[.toast]:leading-tight group-[.toast]:mt-0",
          actionButton:
            "group-[.toast]:!bg-[var(--accent)] group-[.toast]:!text-[var(--accent-fg)] group-[.toast]:font-medium",
          cancelButton:
            "group-[.toast]:!bg-[var(--bg-panel)] group-[.toast]:!text-[var(--fg-muted)]",
          ...
          error:
            "group-[.toaster]:!border-[var(--danger)]/30 group-[.toaster]:!text-[var(--danger)]",
          success:
            "group-[.toaster]:!border-[var(--success)]/30 group-[.toaster]:!text-[var(--success)]",
        },
      }}
      {...props}
    />
